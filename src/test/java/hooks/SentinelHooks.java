...
/**
 * Per-scenario setup and teardown. Without this, browser and page state leaks
 * from one scenario into the next. The "hooks" package is listed in the
 * TestRunner glue path.
 */
